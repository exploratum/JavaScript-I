...
console.log("**********Information about car 33 - STRETCH GOAL - find()*************");
console.log(`Car 33 is a ${inventory.find((car) => car.id===33).car_year} ${inventory.find((car) => car.id===33).car_make} ${inventory.find((car) => car.id===33).car_model}` );

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.

console.log("**********Information about last car*************");
let lastCar = 0;
lastCar = inventory.length -1;
console.log(`Car Make: ${inventory[lastCar].car_make}, Car Model: ${inventory[lastCar].car_model}`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console

console.log("**********Alphabetical listing of model names*************");
let carModels = [];

for(let entry of inventory) {
    carModels.push(entry.car_model);
}
...
console.log("**********Listing of car years*************");
let carYears = [];
for (let entry of inventory) {
    carYears.push(entry.car_year);
}
console.log(carYears);

// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made 
//before the year 2000 by populating the array oldCars and logging it's length.

console.log("**********Number of cars older than 2000 - WITH STRETCH GOAL - filter()************");

 let oldCars = [];

//  for (let entry of inventory) {
//     if(entry.car_year<2000) 
//         oldCars.push(entry);
// }
...
console.log("**********Listong of BMW or AUdi cars - WITH STRETCH GOAL - filter()*************");
